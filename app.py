...
def main():
    ...
    st.title("Chat with documents using LLM 🦙🦜")

    uploaded_files = st.sidebar.file_uploader("Choose multiple files or a single file", accept_multiple_files=True, type=['pdf', 'xlsx', 'csv', 'epub', 'png', 'jpeg', 'pptx'])
    if uploaded_files:
